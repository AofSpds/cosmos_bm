...
Source verification snapshot: standalone C04 and current B01–B04 bytes were hash-verified on `2026-08-29 KST`. Source publication, manifest, and byte preservation remain the source-ingest lane's responsibility.
